...
from model.feature_pyramid_network import FasterRCNN
...
def save(model):
    ...
    save_path = 'checkpoints/feature_pyramid_network_%s' % timestr
...
#     state_dict = torch.load('./checkpoints/feature_pyramid_network_12090844')
#     model.load_state_dict(state_dict)
