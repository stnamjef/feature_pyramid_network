...
from model.utils.creator_tool_fpn import AnchorTargetCreator, ProposalTargetCreator, ProposalCreator
...
class RoIHead(nn.Module):
    ...
    def forward(self, features, rois):
        ...
        # roi_level = torch.sqrt(H * W)
        # roi_level[roi_level < 192] = 3
        # roi_level[(roi_level >= 192) & (roi_level < 384)] = 4
        # roi_level[roi_level >= 384] = 5
        # # End!
        ...
        for i, l in enumerate(range(3, 6)):
            ...
            idx_l = torch.where(roi_level == l)[0]
